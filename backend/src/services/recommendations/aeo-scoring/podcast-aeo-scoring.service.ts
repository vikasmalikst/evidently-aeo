...
export class PodcastAEOScoringService implements IAEOScoringService {
    public calculateScrapabilityScore(content: string): AEOScoreResult {
        // TODO: Implement Podcast scoring (Discussion themes, speaker ID, etc.)
        return {
            totalScore: 0,
            breakdown: {
                primaryAnswer: { score: 0, max: 20, status: 'warning', feedback: "Podcast scoring not yet implemented." },
                // chunkability removed - not relevant for podcast structure
                ...
                authority: { score: 0, max: 20, status: 'warning', feedback: "Not implemented" },
