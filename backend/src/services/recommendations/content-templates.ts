import { StructureSection, ContentTemplateType } from './recommendation.types';
...
export const getContentTemplates = (context?: { brandName?: string; competitors?: string[] }): Record<ContentTemplateType, StructureSection[]> => {
    ...
    } as Record<ContentTemplateType, StructureSection[]>;
};

/**
 * Detects the Content Template Type from the recommendation action string.
 */
