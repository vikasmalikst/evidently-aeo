...
import { SourceTopicHeatmap } from '../components/Sources/SourceTopicHeatmap';
        ...
        {activeTab === 'coverage' && (
          <div style={{ backgroundColor: '#ffffff', padding: '24px', borderRadius: '8px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <div>
                <h2 style={{ fontSize: '20px', fontWeight: '600', color: '#1a1d29', fontFamily: 'Sora, sans-serif', margin: '0 0 8px 0' }}>
                  Source-Topic Coverage Heatmap
                </h2>
                <p style={{ fontSize: '14px', color: '#393e51', margin: 0, lineHeight: '1.6' }}>
