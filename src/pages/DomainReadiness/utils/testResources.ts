// Test Resources Mapping for Domain Readiness
// Maps each test to educational resources and fix instructions
...
export const CATEGORY_DEFINITIONS: Record<string, string> = {
    technicalCrawlability: 'Can AI bots access and crawl your site effectively?',
    contentQuality: 'Is your content fresh, authoritative, and answer-ready?',
    semanticStructure: 'Is your content structured for machine understanding?',
    accessibilityAndBrand: 'Is your site accessible and brand-consistent?',
    aeoOptimization: 'Are you optimized specifically for AI answer engines?'
};
